...
A: A token is use for authentication, a regular token ( non json) is stored in local storage

- [ ] What steps can you take in your web apps to keep your data secure?

A: Some examples from this sprint are, Keeping software up to date, Protected routes, routes that render after authentication login, secure passwords

- [ ] Describe how web servers work.

A: Web servers are basically computers that store code for a website thjat "serve" the web pages when requested

- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

A: 
C - create = .post -- adds data to server
R - read = .get -- retrieved data
U - update = .post -- edits data 
D - delete = .delete -- deletes data
